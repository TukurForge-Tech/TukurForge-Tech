...
function arrancarDemo() {
    ...
    const overlayHtml = `
        <div id="video-overlay" class="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center animate-fade-in">
            <video id="video-instrucciones" class="w-full max-w-md rounded-xl shadow-[0_0_40px_rgba(6,182,212,0.4)]" autoplay playsinline>
...
window.saltarVideo = function() {
    ...
    window.location.href = `/abrir/simu_examen_demo.html?v=${localStorage.getItem('demo_token_hex')}`;
}
